document.addEventListener('DOMContentLoaded', async function () {
  ...
  function buildNav(){
    ...
    nav.innerHTML=[['voters','Residents'],['assign','Assign'],['calls','Calls'],['votes','Votes'],['visits','Visits'],['transport','Transport'],['insights','Insights']].map(x=>'<a class="btn '+(x[0]===section?'active':'')+'" href="residents.html?party='+encodeURIComponent(party)+'&section='+x[0]+'&v=sectionfields1">'+x[1]+'</a>').join('')+'<a class="btn" href="index.html?v=sectionfields1">Logout</a>';
  }
  function setTitles(){
